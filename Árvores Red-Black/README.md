...
<br />
<div align="center">
  <h3 align="center">Red-Black Trees</h3>
...
Implemented the insertion and removal operations of nodes in the Red-Black Tree.
Remembering that these operations maintain the properties of the Red-Black Tree (perfect balance of black edges, red edges descending to the left, and not having two red edges in sequence).
